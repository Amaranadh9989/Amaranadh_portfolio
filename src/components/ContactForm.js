    ...
    <div  id="ContactForm" className="ContactForm">
      ...
      <form action="https://formsubmit.co/683c2aec7b2abc33377c8b4b55e6e404 " method="POST">
        <div className="half left cf">
          <input type="text" name="text" className="input-name" placeholder="Name" />
          <input type="email" name="email" className="input-email" placeholder="Email address" />
          <input type="text" name="text" className="input-subject" placeholder="Subject" />
        </div>
        <div className="half right cf" id='mesage_container' >
          <textarea name="message" className="input-message" placeholder="Message"></textarea>
        </div>  
